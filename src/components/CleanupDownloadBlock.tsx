...
export const CleanupDownloadBlock: React.FC<CleanupDownloadBlockProps> = ({
  ...
  const metadataSummary = removeMetadata
    ? t('privacyDiffMetadataAndSensorRemoved')
    : t('privacyDiffMetadataAndSensorKept');
  ...
  const colorSummary = colorSimplification
    ? t('privacyDiffColorReduced')
    : t('privacyDiffColorFull');
    ...
    <section className="panel cleanup-panel">
      ...
      <div className="cleanup-options cleanup-options--grid">
        <label className="cleanup-checkbox">
          ...
          />
          <span>
            <strong>{t('removeMetadataAndSensorLabel')}</strong>
            <small>{t('removeMetadataAndSensorHint')}</small>
          </span>
        </label>
        <label className="cleanup-checkbox">
