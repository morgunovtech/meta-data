            ...
            <div style={{ display: 'grid', gap: '1rem' }}>
              ...
              <div>
                <p>
                  ...
                  {(metadata?.gps?.accuracy ?? reverseFetch.data?.precisionMeters) != null
                    ? t('accuracyMeters', {
                        value: Math.round(
                          (metadata?.gps?.accuracy ?? reverseFetch.data?.precisionMeters) as number
                        )
                      })
                    : t('emptyValue')}
                </p>
              ...
              ) : !reverseFetch.loading && !reverseFetch.error ? (
                <p className="notice">{t('addressPending')}</p>
              ) : null}
            </div>
          ) : null}
        </section>
