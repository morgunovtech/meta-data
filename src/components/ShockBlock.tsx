...
export const ShockBlock: React.FC<ShockBlockProps> = ({ metadata, manualCoords, onManualCoordsChange }) => {
  ...
  const timezoneRequest = timezoneFetch.request;
  ...
  }, [coords, timestamp, timezoneRequest]);
  ...
  const accuracyValue = metadata?.gps?.accuracy ?? reverseFetch.data?.precisionMeters;
          ...
          {coords ? (
            <div className="map-section">
              <div className="map-frame">
                <MapBlock lat={coords.lat} lon={coords.lon} accuracy={accuracyValue} />
              </div>
              <div className="map-details">
                <dl>
                  <div>
                    <dt>{t('coordinatesLabel')}</dt>
                    <dd>
                  ...
                  <div>
                    ...
                    <dd>
                      {accuracyValue
                        ? t('accuracyMeters', { value: Math.round(accuracyValue) })
                        : t('emptyValue')}
                    </dd>
                  </div>
                  <div>
                    ...
                    <dd>
                      {reverseFetch.loading
                        ? t('mapLoading')
                        : reverseFetch.data?.address ?? t('emptyValue')}
                    </dd>
                  </div>
                  <div>
                    ...
                    <dd>
                      {reverseFetch.data
                        ? `${reverseFetch.data.country} (${reverseFetch.data.countryCode ?? t('emptyValue')})`
                        : t('emptyValue')}
                    </dd>
                  </div>
                </dl>
                <div className="controls-row">
                  ...
                  <a
                    ...
                    href={streetViewLink(coords.lat, coords.lon, metadata?.gps?.heading)}
                    target="_blank"
                    rel="noreferrer"
                  >
                    {t('openStreetView')}
