...
const messages = {
  ru: {
    ...
    contentAutoNote: 'Содержимое анализируется автоматически локально — рамки с объектами появляются поверх превью.',
    ...
    contentDescription: 'Обнаружено: {description}',
    contentBoxesInfo: 'Рамки рисуются поверх превью автоматически; размывание лиц опирается на них.',
    contentNoDetections: 'Объекты не обнаружены, зато метаданные доступны полностью.',
  ...
  en: {
    ...
    addressPending: 'Address is being resolved…',
    ...
    contentAutoNote: 'We analyse the scene locally and draw detection boxes automatically over the preview.',
    contentLoading: 'Loading model…',
    contentUnavailable: 'Your device seems too weak for content analysis. Metadata tools still work.',
    contentDescription: 'Detected: {description}',
    contentBoxesInfo: 'Detections are highlighted automatically; face blurring relies on these boxes.',
    contentNoDetections: 'No objects detected — metadata tools still work fully.',
  ...
  uz: {
    ...
    addressPending: 'Manzil aniqlanmoqda…',
    addressLabel: 'Manzil',
    ...
    contentAutoNote: 'Tahlil brauzerda avtomatik bajariladi va topilgan obyektlar prevyuda ko‘rsatiladi.',
    ...
    contentDescription: 'Aniqlandi: {description}',
    contentBoxesInfo: 'Chegaralar avtomatik chiziladi; yuzlarni xira qilish aynan shu maʼlumotga tayangan.',
    contentNoDetections: 'Obyektlar topilmadi — lekin metamaʼlumotlar to‘liq ishlaydi.',
    ...
    language: 'Til',
    languageRussian: 'Rus tili',
    languageEnglish: 'Ingliz tili',
    languageUzbek: 'O‘zbek tili',
