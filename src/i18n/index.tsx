...
const messages = {
  ru: {
    ...
    typeValueImage: 'Изображение',
    typeValueUnknown: 'Неизвестно',
    sizeHumanBytes: '{human} ({bytes} байт)',
    ...
    contentSummaryCounts: 'Людей — {people}, транспорт — {vehicles}, животные — {animals}',
    contentTopObjects: 'Наиболее вероятные объекты: {list}',
    contentBoxesAuto: 'Рамки отображаются автоматически для найденных объектов.',
    contentNoDetections: 'Значимых объектов не обнаружено (порог 50%).',
    ...
    objectPerson: 'люди',
    objectCar: 'автомобили',
    objectBus: 'автобусы',
    objectTruck: 'грузовики',
    objectBicycle: 'велосипеды',
    objectMotorcycle: 'мотоциклы',
    objectTrain: 'поезда',
    objectDog: 'собаки',
    objectCat: 'кошки',
    objectBird: 'птицы',
  ...
  en: {
    ...
    typeValueImage: 'Image',
    typeValueUnknown: 'Unknown',
    sizeHumanBytes: '{human} ({bytes} bytes)',
    ...
    contentSummaryCounts: 'People — {people}, vehicles — {vehicles}, animals — {animals}',
    contentTopObjects: 'Top objects: {list}',
    contentBoxesAuto: 'Bounding boxes appear automatically for detected objects.',
    contentNoDetections: 'No confident objects detected (50% threshold).',
    ...
    objectBus: 'buses',
    objectTruck: 'trucks',
    objectBicycle: 'bicycles',
    objectMotorcycle: 'motorcycles',
    objectTrain: 'trains',
    objectDog: 'dogs',
    objectCat: 'cats',
    objectBird: 'birds',
  ...
  uz: {
    ...
    typeValueImage: 'Rasm',
    typeValueUnknown: 'Nomaʼlum',
    sizeHumanBytes: '{human} ({bytes} bayt)',
    ...
    contentSummaryCounts: 'Odamlar — {people}, transport — {vehicles}, hayvonlar — {animals}',
    contentTopObjects: 'Eng ehtimoliy obyektlar: {list}',
    contentBoxesAuto: 'Aniqlangan obyektlar uchun ramkalar avtomatik ko‘rsatiladi.',
    contentNoDetections: '50% ishonchlilik chegarasida obyektlar topilmadi.',
    ...
    languageRu: 'Rus tili',
    languageEn: 'Ingliz tili',
    languageUz: 'Oʻzbek tili',
    objectPerson: 'odamlar',
    objectCar: 'mashinalar',
    objectBus: 'avtobuslar',
    objectTruck: 'yuk mashinalari',
    objectBicycle: 'velosipedlar',
    objectMotorcycle: 'motosikllar',
    objectTrain: 'poezdlar',
    objectDog: 'itlar',
    objectCat: 'mushuklar',
    objectBird: 'qushlar',
    objectHorse: 'otlar',
