...
const messages = {
  ru: {
    ...
    insightLocationAddress: 'Координаты совпадают с адресом: {address}.',
    insightLocationCountry: 'Страна: {country} ({code}).',
    insightLocationCoordinates: 'Даже без адреса остались точные координаты {lat}, {lon}.',
    insightLocationAccuracy: 'Погрешность GPS — около {accuracy} м.',
    ...
    insightOsTitle: 'Программная среда',
    ...
    insightPoiValue: 'Рядом {category} «{name}» — всего {distance} м от точки съёмки.',
  ...
  en: {
    ...
    insightLocationAddress: 'Coordinates match the address: {address}.',
    insightLocationCountry: 'Country: {country} ({code}).',
    insightLocationCoordinates: 'Precise coordinates remain: {lat}, {lon}.',
    insightLocationAccuracy: 'GPS accuracy is about {accuracy} m.',
    ...
    insightPoiValue: '{category} “{name}” is just {distance} m away from the spot.',
    insightPoiUnnamed: '{category}',
  ...
  uz: {
    ...
    insightLocationAddress: 'Koordinatalar manzil bilan mos: {address}.',
    insightLocationCountry: 'Davlat: {country} ({code}).',
    insightLocationCoordinates: 'Aniq koordinatalar saqlanib qolgan: {lat}, {lon}.',
    insightLocationAccuracy: 'GPS aniqligi taxminan {accuracy} m.',
    ...
    insightPoiValue: '{category} “{name}” atigi {distance} m masofada.',
    insightPoiUnnamed: '{category}',
